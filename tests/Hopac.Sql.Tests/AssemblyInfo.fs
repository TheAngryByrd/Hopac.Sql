...
[<assembly: AssemblyTitleAttribute("Hopac.Sql.Tests")>]
[<assembly: AssemblyProductAttribute("Hopac.Sql")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Hopac.Sql.Tests"
    let [<Literal>] AssemblyProduct = "Hopac.Sql"
